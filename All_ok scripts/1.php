...
$jira_username = 'Akohale';
$jira_password = 'Thecrypt1987';
$jira_project = 'PDD';
$jira_issue_type = 'Bug';
$pd_subdomain = 'videology';
$pd_api_token = 'JjvzkWgm54eDmxpxoS5J';
print "Welcome to Tier2";
if ($messages) foreach ($messages->messages as $webhook) {
  ...
  switch ($webhook_type) {
    case "incident.trigger":
      ...
      $summary = "[PagerDuty Alert]: #$incident_number, $trigger_summary_data";
